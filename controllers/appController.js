...
//   try {
//     let { profile, email, userName, password } = req.body;
...
//         }
//         if (user) {
//           reject({ error: "Please provide unique userName" });
//         }
...
//         }
//         if (email) {
//           reject({ error: "Please provide unique email " });
//         }
...
//               //return and save as a responce
//               user
//                 .save()
//                 .then((result) => {
//                   return res
//                     .status(201)
//                     .send({ msg: "User Register Sucessfully" });
//                 })
//                 .catch((error) => {
...
export async function register(req, res) {
  try {
    ...
    Promise.all([existUsername, existEmail])
      ...
      .catch((error) => {
        return res.status(500).send({ error: "Something crashed" });
      });
  } catch (error) {
